...
public class ChunkProviderFarlands implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    private NoiseGeneratorFarlandsOctaves field_147431_j;
    private NoiseGeneratorFarlandsOctaves field_147432_k;
    private NoiseGeneratorFarlandsOctaves field_147429_l;
    private NoiseGeneratorPerlin field_147430_m;
    /** A NoiseGeneratorFarlandsOctaves used in generating terrain */
    public NoiseGeneratorFarlandsOctaves noiseGen5;
    /** A NoiseGeneratorFarlandsOctaves used in generating terrain */
    public NoiseGeneratorFarlandsOctaves noiseGen6;
    public NoiseGeneratorFarlandsOctaves mobSpawnerNoise;
    ...
    public ChunkProviderFarlands(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
        ...
        this.field_147431_j = new NoiseGeneratorFarlandsOctaves(this.rand, 16);
        this.field_147432_k = new NoiseGeneratorFarlandsOctaves(this.rand, 16);
        this.field_147429_l = new NoiseGeneratorFarlandsOctaves(this.rand, 8);
        this.field_147430_m = new NoiseGeneratorPerlin(this.rand, 4);
        this.noiseGen5 = new NoiseGeneratorFarlandsOctaves(this.rand, 10);
        this.noiseGen6 = new NoiseGeneratorFarlandsOctaves(this.rand, 16);
        this.mobSpawnerNoise = new NoiseGeneratorFarlandsOctaves(this.rand, 8);
        ...
        this.field_147431_j = (NoiseGeneratorFarlandsOctaves)noiseGens[0];
        this.field_147432_k = (NoiseGeneratorFarlandsOctaves)noiseGens[1];
        this.field_147429_l = (NoiseGeneratorFarlandsOctaves)noiseGens[2];
        this.field_147430_m = (NoiseGeneratorPerlin)noiseGens[3];
        this.noiseGen5 = (NoiseGeneratorFarlandsOctaves)noiseGens[4];
        this.noiseGen6 = (NoiseGeneratorFarlandsOctaves)noiseGens[5];
        this.mobSpawnerNoise = (NoiseGeneratorFarlandsOctaves)noiseGens[6];
    }
