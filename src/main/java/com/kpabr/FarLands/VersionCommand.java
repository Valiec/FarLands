...
public class VersionCommand extends CommandBase
{
    ...
    try
    {
        Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("You have FarLands "+FarLands.VERSION+". Newest release is FarLands "+FarLands.versionChecker.getNewestVersionNumber()+"."));
    }
